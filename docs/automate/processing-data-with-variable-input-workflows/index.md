...
This allows for solving all kinds of [☆ Automation](/automate) tasks when, for instance, a large number of small data snippets or similar needs to be processed.
